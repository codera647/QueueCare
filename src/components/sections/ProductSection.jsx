...
function MonitorShell({ children }) {
  return (
    <motion.div
      ...
      className="relative mx-auto min-h-[320px] w-full max-w-[760px] overflow-visible sm:min-h-[400px] md:min-h-[500px] lg:mx-0 lg:min-h-[560px] xl:min-h-[600px]"
    >
      <div className="pointer-events-none absolute left-[16%] top-[4%] h-[320px] w-[320px] rounded-full bg-[radial-gradient(circle,rgba(22,163,74,0.12),rgba(234,249,239,0.16),transparent_72%)] blur-2xl" />
      <div className="pointer-events-none absolute left-[4%] top-[12%] h-[90px] w-[90px] bg-[radial-gradient(circle,rgba(22,163,74,0.2)_1.2px,transparent_1.2px)] [background-size:14px_14px] opacity-20" />
      <div className="pointer-events-none absolute left-[12%] bottom-[16%] h-[84px] w-[110px] bg-[radial-gradient(circle,rgba(22,163,74,0.18)_1.2px,transparent_1.2px)] [background-size:14px_14px] opacity-20" />

      <div className="origin-top scale-[0.46] sm:scale-[0.62] md:scale-[0.8] lg:scale-100">
        <div className="relative mx-auto w-[720px] max-w-none pt-4 lg:mx-0">
          <div className="absolute bottom-[12px] left-1/2 -z-10 h-[32px] w-[210px] -translate-x-1/2 rounded-full bg-[rgba(16,32,24,0.12)] blur-[12px]" />

          <div className="relative overflow-hidden rounded-[28px] border-[10px] border-[#1A211D] bg-[#1A211D] shadow-[0_30px_80px_rgba(15,122,58,0.12),0_16px_38px_rgba(16,32,24,0.12)]">
            <div className="absolute inset-x-0 top-0 h-[14px] bg-[linear-gradient(180deg,rgba(255,255,255,0.10),transparent)]" />

            <div className="m-[8px] overflow-hidden rounded-[20px] bg-[#FAF7F0]">
              <div className="h-[428px]">{children}</div>
            </div>
          </div>

          <div className="mx-auto h-[78px] w-[40px] rounded-b-[22px] rounded-t-[18px] bg-[linear-gradient(180deg,#E2E7E1_0%,#BCC6BD_100%)] shadow-[0_8px_16px_rgba(16,32,24,0.08),inset_0_1px_0_rgba(255,255,255,0.88)]" />
          <div className="mx-auto mt-[-8px] h-[22px] w-[208px] rounded-[999px] bg-[linear-gradient(180deg,#D3DCD3_0%,#AEB9B0_100%)] shadow-[0_10px_18px_rgba(16,32,24,0.12),inset_0_1px_0_rgba(255,255,255,0.82)]" />
        </div>
      </div>
    </motion.div>
  );
...
function DashboardScreen() {
  ...
  return (
    <div className="grid h-full grid-cols-[124px_1fr]">
      <div className="border-r border-[rgba(22,163,74,0.08)] bg-white/70 px-2.5 py-3">
      ...
      <div className="px-5 py-5">
        <div className="flex items-center justify-between gap-3 border-b border-[rgba(22,163,74,0.08)] pb-3">
        ...
        <div className="pt-4">
          ...
          <div className="mt-3 overflow-hidden rounded-[18px] border border-[rgba(22,163,74,0.08)] bg-white/82">
            <div className="grid grid-cols-[0.8fr_1.15fr_1.15fr_0.85fr_0.95fr] gap-2 border-b border-[rgba(22,163,74,0.08)] px-3 py-2 text-[9px] font-semibold uppercase tracking-[0.08em] text-[#7A8A82]">
              <span>Token</span>
              <span>Patient</span>
              <span>Service</span>
              <span>Time</span>
            ...
            <div className="divide-y divide-[rgba(22,163,74,0.06)]">
              {rows.slice(0, 3).map((row, index) => (
                <motion.div
                  ...
                  className="grid grid-cols-[0.8fr_1.15fr_1.15fr_0.85fr_0.95fr] gap-2 px-3 py-2 text-[10px] text-[#102018]"
                >
                  <span className="font-bold">{row.token}</span>
                  <span>{row.patient}</span>
                  <span className="text-[#5B6B63]">{row.service}</span>
                  <span className="text-[#5B6B63]">{row.time}</span>
                  <span>
...
function PatientAppScreen() {
  return (
    <div className="grid h-full place-items-center bg-[linear-gradient(180deg,#F8FBF8_0%,#F1F6F2_100%)] px-5 py-5 sm:px-6 sm:py-6">
      <div className="mx-auto w-full max-w-[620px] origin-center scale-[0.92] xl:scale-[0.96] 2xl:scale-100">
      <div className="grid w-full gap-3 lg:grid-cols-[0.92fr_1.08fr]">
...
function NotificationsScreen() {
  ...
  return (
    <div className="h-full bg-[linear-gradient(180deg,#F7FBF8_0%,#EFF6F1_100%)] px-8 py-7">
...
function AnalyticsScreen() {
  return (
    <div className="h-full bg-[linear-gradient(180deg,#F9FBF8_0%,#F1F5F2_100%)] px-5 py-5 sm:px-6 sm:py-6">
      <div className="mx-auto w-full max-w-[680px] origin-center scale-[0.92] xl:scale-[0.96] 2xl:scale-100">
      <div className="flex items-center justify-between">
        <div>
      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
        <div className="rounded-[24px] border border-[rgba(22,163,74,0.12)] bg-white/92 p-4 shadow-[0_20px_44px_rgba(16,32,24,0.06)]">
          ...
          <svg viewBox="0 0 360 160" className="mt-4 h-[190px] w-full lg:h-[180px]" aria-hidden="true">
            <defs>
...
function MainProductShowcase({ activeProduct }) {
  ...
  return (
    <div className="relative w-full min-h-[520px] overflow-visible lg:min-h-[560px] xl:min-h-[600px]">
    <MonitorShell>
...
function DemoVideoCard() {
  return (
    <motion.div
      ...
      whileHover={{ y: -4 }}
      className="relative h-[220px] overflow-hidden rounded-[28px] border border-[rgba(22,163,74,0.12)] bg-[linear-gradient(135deg,#0F7A3A_0%,#16A34A_48%,#8DBD48_100%)] p-5 text-white shadow-[0_28px_70px_rgba(15,122,58,0.20)] sm:h-[240px] sm:p-6 md:h-[260px] lg:h-[250px] xl:h-[280px] xl:p-7"
    >
      ...
      <div className="relative flex h-full flex-col">
        ...
        <div className="flex flex-1 items-center justify-center">
          <motion.button
            ...
            className="grid h-[86px] w-[86px] place-items-center rounded-full bg-white text-[#16A34A] shadow-[0_18px_40px_rgba(16,32,24,0.18)]"
          >
      ...
      {steps.map((step, index) => {
        ...
        return (
          <motion.div
            ...
            whileHover={{ y: -3 }}
            className="relative flex min-h-[88px] items-center gap-4 rounded-[22px] border border-[rgba(22,163,74,0.12)] bg-white/92 px-4 py-4 shadow-[0_18px_44px_rgba(16,32,24,0.08)] sm:px-[22px] sm:py-[18px] md:min-h-[92px]"
          >
            <div className="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-[#16A34A] text-sm font-bold text-white">
              {step.number}
            </div>
            <div className="grid h-[46px] w-[46px] shrink-0 place-items-center rounded-2xl bg-[#EAF9EF] text-[#16A34A]">
              <Icon size={18} />
            </div>
...
function ProductModeCards({ activeProduct, onSelect }) {
  return (
    <div className="mt-10 grid grid-cols-1 gap-4 md:mt-12 md:grid-cols-2 xl:mt-14 xl:grid-cols-4">
...
export default function ProductSection() {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1500px] px-4 py-14 sm:px-6 sm:py-16 md:px-8 md:py-20 lg:px-10 lg:py-24 xl:px-12">
        <motion.div
          initial={{ opacity: 0, y: 18 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, amount: 0.3 }}
